...
## Short description (A/B variants)

**Variant A – Mindfulness + Privacy**  
Set gentle time limits, pause before scrolling, and build mindful habits — 100% private and stored locally on your device.

**Variant B – Focus + Students/Work**  
Stop mindless scrolling with daily website limits and focus tools — free, private, and designed for study and deep work.
...
- 🌙 Daily reset for a fresh start every day  
- ✍️ Intentional overrides that make you pause and reflect  

---

## ⚙️ Core features

**Set daily website time limits**  
Control how long you spend on distracting websites and reduce mindless scrolling.

**Limit groups of sites**  
Avoid switching between social media platforms when your time runs out.

**Mindful timeout screen**  
When you reach your limit, you’ll see healthier alternatives like stretching, walking, or reading.

**One intentional extension per day**  
Need more time for something important? Write a short reason and continue mindfully.

**Quick add from the popup**  
Add the current site to a limit in seconds.

**Simple onboarding**  
Start building better habits and improving focus in under a minute.
...
## 🚀 Coming soon
- Reflection delay before opening distracting sites  
- Personal usage insights and progress over time  
- Smart suggestions for website time limits  
